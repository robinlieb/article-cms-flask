...
class Config(object):
    ...
    SQL_DRIVER = os.environ.get('SQL_DRIVER') or 'ENTER_SQL_SERVER_DRIVER'
    ...
    SQLALCHEMY_DATABASE_URI = 'mssql+pyodbc://' + SQL_USER_NAME + '@' + SQL_SERVER + ':' + SQL_PASSWORD + '@' + SQL_SERVER + ':1433/' + SQL_DATABASE  + '?driver=' + SQL_DRIVER
